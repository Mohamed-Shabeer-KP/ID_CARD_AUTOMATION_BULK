...
public class Design extends javax.swing.JFrame {
    ...
    public Design(DefaultTableModel MainTable)
    {
        initComponents();
        this.MainTable=MainTable;
   
        pdf_pb.setMinimum(0);
        pdf_pb.setMaximum(MainTable.getRowCount()-2);
    }
    ...
    private void initComponents() {
        ...
        save_panel1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(102, 102, 255), 3, true));
        save_panel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        save_panel1.add(pdf_pb, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 330, 30));

        progress_label.setFont(new java.awt.Font("Courier New", 1, 18)); // NOI18N
    ...
    private javax.swing.JProgressBar pdf_pb;
